        ...
        <div class="admin-wrapper">
            ...
            <!-- Admin Content -->
             <div class="admin-content">
                 ...
                 <form action ="<?=base_url('auth/processtokens') ?>" method="post"> 
                        <div>
          ...
          <label>API USER:</label>
            <?php
              ...
              echo form_dropdown('api_userid', $apiuser_options);
            ?>
            <label>API-PRODUCT USER:</label>
            <?php
            echo form_dropdown('api_productid', $apiproduct_options);
            ?>
