        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <h2 class="page-title">Manage SubCategory</h2>
              ...
              <tbody>
                  ...
                  foreach( $results as $sublist){
                    ?>
                  <tr>
                     <td>
                          <a>
                              <?php echo $sublist->subcategory_id; ?>
                          </a>
                      </td>
                      ...
                      <td>
                          <a>
                              <?php echo $sublist->subcategory_name; ?>
                          </a>
                      </td>
                      <td>
                          <a>
                              <?php echo $sublist->category_id; ?>
                          </a>
                      </td>
                      <td class="project-actions text-right">
                          <a class="btn btn-info btn-sm" href="/pages/editSubcategory/<?php echo $sublist->subcategory_id; ?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="/auth/subcategory_delete/<?php echo $sublist->subcategory_id; ?>">
