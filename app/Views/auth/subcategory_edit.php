        ...
        <div class="admin-wrapper">
           ...
           <div class="admin-content">
                <div class="button-group">
                    <a href="<?=site_url('Pages/addsubcategories');?>" class="btn btn-big">Add SubCategory</a>
                    <a href="<?=site_url('Pages/subcategoryshow');?>" class="btn btn-big">Manage SubCategory</a>
                </div>
                ...
                <div class="content">
                  ...
                  $query=$db->query('SELECT subcategory_id,subcategory_name,category_id FROM tbl_subcategories');
                  $results=$query->getResult();


                  foreach( $results as $tbl_subcategories){?>

                     <form action ="<?php echo base_url('auth/subupdate/'.$tbl_subcategories->subcategory_id);?>" method="post"> 
                

                 <div class="col-md-6 register-bottom-grid">
                     <div>
                        <label>Subcategory Name</label>
                         <input type="text" name="subcategory" value="<?php echo $tbl_subcategories->subcategory_name; ?>"> 
                        <span class="text-danger"><? =isset($validation) ?display_error($validation,'subcategory'): ''?></span>         
                    </div>
                     <button type="submit" class="btn btn-big">Change subcategory Details</button>
                     </div>
